                ...
                <div className="end-modal"> 
                    ...
                    {blackjackState === "dealer-gameover" && (
                        <>
                            ...
                            <h5>{`You've won and receieved double of your bet, ${betAmount * 2} €!`}</h5>
                        </>
                    )}
                    {blackjackState === "player-gameover" && (
                        <>
                            <h5>Dealer has {dealerCardValues}, you have {playerCardValues}.</h5>
                            <h5>Dealer is closer to 21. You have lost your bet, {betAmount} €. </h5>
                        </>
                    )}
                    {blackjackState === "player-closer" && (
                        <>
                            <h5>Dealer has {dealerCardValues}, you have {playerCardValues}.</h5>
                            <h5>{`Your cards are closer to 21. You've won and doubled your bet! You get ${betAmount * 2} €!`}</h5>
                        </>
                    )}
                </div>
                <>
